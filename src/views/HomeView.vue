<template>
  ...
  <div class="space-y-2 text-center md:text-left px-20 md:w-1/2"> 
    <p class="text-amber-200">Hello World, I'm</p>
    
    <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up whitespace-nowrap">
      Rio Adriana
    </h1>
 ...
 <a 
  ...
  download="Resume_Rio_Adriana.pdf"
  ...
  Download Resume
    ...
    <div class="flex justify-center md:justify-start fadein-right">
      <img
        ...
        decoding="async"
        data-nimg="1"
        class="w-4/6 md:h-auto rounded-full border-4 border-amber-200 pict"
        src="/img/yoojin.jpeg">
    </div>
  </main>
  </template>
